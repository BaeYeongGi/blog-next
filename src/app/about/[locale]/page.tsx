...
const Page = ({ params }: PageProps) => {
  ...
  return (
    ...
    <Title classValue={styles.title} value='About TEST COMMIT 3'/>
    <p className={styles.text}>{data.about}</p>
    <Division classValue={styles.division}/>
    <Title classValue={styles.title} value='Skills TEST COMMIT 3'/>
    ...
    <Division classValue={styles.division}/>
    <Title classValue={styles.title} value='Work Experience TEST COMMIT 3'/>
    {
